...
// Platform-aware config directory (matches config.js paths)
const CONFIG_DIR = process.env.XDG_CONFIG_HOME
  ? path.join(process.env.XDG_CONFIG_HOME, 'voicci')
  : (os.platform() === 'darwin'
    ? path.join(os.homedir(), 'Library', 'Application Support', 'voicci', 'config')
    : path.join(os.homedir(), '.config', 'voicci'));
